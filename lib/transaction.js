...
function Transaction(client, container, config, outerTx) {
  ...
  var txid = this.txid = (0, _uniqueId3.default)('trx');
  ...
  this._promise = _bluebird2.default.using(this.acquireConnection(client, config, txid), function (connection) {
...
(0, _inherits2.default)(Transaction, _events.EventEmitter);

(0, _assign3.default)(Transaction.prototype, {
